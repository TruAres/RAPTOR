...
// // constructor
// H1SingleStepOptimizer::H1SingleStepOptimizer()
// {
// }
...
bool H1SingleStepOptimizer::set_parameters(
    const VecX& x0_input,
 ...
 ) 
{
    ...
    dcidPtr_ = std::make_shared<H1ConstrainedInverseDynamics>(model_input, 
                                                              trajPtr_,
    ...
    constraintsPtrVec_.push_back(std::make_unique<H1CustomizedConstraints>(model_input, 
                                                                              trajPtr_, 
                                                                              dcidPtr_->ddcPtr_,
                                                                              gp_input));    
    ...
    if (periodic) {
        constraintsPtrVec_.push_back(std::make_unique<H1SingleStepPeriodicityConstraints>(trajPtr_, 
                                                                                             dcidPtr_,
                                                                                             FRICTION_PARAMS));    
...
// [TNLP_get_nlp_info]
bool H1SingleStepOptimizer::get_nlp_info(
   Index&          n,
   Index&          m,
   Index&          nnz_jac_g,
   Index&          nnz_h_lag,
