...
// // constructor
// H1MultipleStepOptimizer::H1MultipleStepOptimizer()
// {
// }
...
bool H1MultipleStepOptimizer::set_parameters(
...
) 
{
    ...
    for (int i = 0; i < NSteps_input; i++) {
        stepOptVec_.push_back(new H1SingleStepOptimizer());
    ...
    for (int i = 0; i < NSteps_input - 1; i++) {
        periodConsVec_.push_back(
            std::make_shared<H1MultipleStepPeriodicityConstraints>(
...
// [TNLP_get_nlp_info]
bool H1MultipleStepOptimizer::get_nlp_info(
   Index&          n,
   Index&          m,
   Index&          nnz_jac_g,
   Index&          nnz_h_lag,
...
bool H1MultipleStepOptimizer::get_bounds_info(
    Index   n,
    Number* x_l,
    Number* x_u,
    Index   m,
...
bool H1MultipleStepOptimizer::eval_f(
   Index         n,
   const Number* x,
   bool          new_x,
   Number&       obj_value
...
bool H1MultipleStepOptimizer::eval_grad_f(
   Index         n,
   const Number* x,
   bool          new_x,
   Number*       grad_f
...
bool H1MultipleStepOptimizer::eval_g(
    Index         n,
    const Number* x,
    bool          new_x,
    Index         m,
...
bool H1MultipleStepOptimizer::eval_jac_g(
   Index         n,
   const Number* x,
   bool          new_x,
   Index         m,
...
void H1MultipleStepOptimizer::summarize_constraints(
    Index                      m,
    const Number*              g,
    const bool                 verbose
) 
