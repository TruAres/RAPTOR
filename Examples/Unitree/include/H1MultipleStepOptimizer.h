#ifndef H1_MULTIPLE_STEP_OPTIMIZER_H
#define H1_MULTIPLE_STEP_OPTIMIZER_H
...
class H1MultipleStepOptimizer : public Optimizer {
public:
    ...
    /** Default constructor */
    H1MultipleStepOptimizer() = default;
    ...
    */
    //@{
    H1MultipleStepOptimizer(
       const H1MultipleStepOptimizer&
    );

    H1MultipleStepOptimizer& operator=(
       const H1MultipleStepOptimizer&
    );

    std::vector<SmartPtr<H1SingleStepOptimizer>> stepOptVec_;
    std::vector<std::shared_ptr<H1MultipleStepPeriodicityConstraints>> periodConsVec_;
...
#endif // H1_MULTIPLE_STEP_OPTIMIZER_H
