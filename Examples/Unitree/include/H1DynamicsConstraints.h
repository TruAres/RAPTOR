#ifndef H1_CONSTRAINTS_H
#define H1_CONSTRAINTS_H
...
class H1DynamicsConstraints : public DynamicsConstraints {
public:
    ...
    // Constructor
    H1DynamicsConstraints() = default;

    // Constructor
    H1DynamicsConstraints(const std::shared_ptr<Model>& modelPtr_input,
                          char stanceLeg, 
