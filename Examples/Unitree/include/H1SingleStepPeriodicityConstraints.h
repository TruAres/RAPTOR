...
#ifndef H1_SINGLE_STEP_PERIODICITY_CONSTRAINTS_H
#define H1_SINGLE_STEP_PERIODICITY_CONSTRAINTS_H
...
class H1SingleStepPeriodicityConstraints : public Constraints {
public:
    ...
    // Constructor
    H1SingleStepPeriodicityConstraints() = default;

    // Constructor
    H1SingleStepPeriodicityConstraints(std::shared_ptr<Trajectories>& trajPtr_input,
    ...
    std::shared_ptr<H1ConstrainedInverseDynamics> dcidPtr_;
