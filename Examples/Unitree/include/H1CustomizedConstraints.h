#ifndef H1_CUSTOMIZED_CONSTRAINTS_H
#define H1_CUSTOMIZED_CONSTRAINTS_H
...
class H1CustomizedConstraints : public Constraints {
public:
    ...
    // Constructor
    H1CustomizedConstraints() = default;
...
#endif // H1_CUSTOMIZED_CONSTRAINTS_H
